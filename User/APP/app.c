...
static  void AppTaskOLED ( void * p_arg )
{
    CPU_SR_ALLOC();      //使用到临界段（在关/开中断时）时必需该宏，该宏声明和定义一个局部变
                                 ...
                                 //，开中断时将该值还原.
    /* 发送缓冲区初始化 */
    uint8_t Tx_Buffer[] = "\r\n";
