...
void SPI_FLASH_WriteEnable(void)
{
    ...
    /* 发送写使能命令*/
    SPI_FLASH_SendByte(AT26XX_WriteEnable);
...
void SPI_FLASH_WaitForWriteEnd(void)
{
    ...
    /* 发送 读状态寄存器 命令 */
    SPI_FLASH_SendByte(AT26XX_ReadStatusReg);
...
void SPI_Flash_PowerDown(void)
{
    ...
    /* 发送 掉电 命令 */
    SPI_FLASH_SendByte(AT26XX_PowerDown);
...
void SPI_Flash_WAKEUP(void)
{
    ...
    /* 发送 上电 命令 */
    SPI_FLASH_SendByte(AT26XX_ReleasePowerDown);
